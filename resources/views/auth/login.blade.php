...
<html lang="pt-br">
	...
	<body class="login">
		...
		<div id="app" style="background-color: white; "> 
			...
			<div class="cor_fundo_azul" style="width:100%; height:170px; text-align: center;">
				<img class="logo_topo" src="{{ asset("img/agenersa.png") }}">
			</div>
			<div id="app">
				...
				<div class="animate form login_form">
					<section class="login_content">
						<form method="POST" action="{{ route('login') }}">
							...
							<h1 class="cor_texto_azul">AGENERSA - Sistema de ......</h1>
			...
			<footer class="rodape ">
				<div class="separator">
					<i style=" color:black" class="fab fa-free-code-camp"></i>
